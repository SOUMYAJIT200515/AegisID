  ...
  const handleAction = async (id: number, action: string, data?: any) => {
    ...
    try {
      ...
      if (action === "transfer") {
        ...
        if (selectedAssetDetails && (selectedAssetDetails.id === id || selectedAssetDetails.assetId === id)) {
                      ...
                      {canManageAssets && (
                        <>
                          <button
                            ...
                            className="p-1.5 hover:bg-slate-100 dark:hover:bg-white/5 text-slate-500 dark:text-slate-400 rounded-lg transition-colors inline-flex border border-transparent disabled:opacity-50"
                          >
                          ...
                          {a.status === "ACTIVE" ? (
                            <button
                              ...
                              disabled={actionLoading === a.id}
                              title="Suspend Asset"
                              className="p-1.5 hover:bg-amber-50 dark:hover:bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-lg transition-colors inline-flex border border-transparent disabled:opacity-50"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-lg transition-colors inline-flex border border-transparent disabled:opacity-50"
                            >
                          ...
                          <button
                            ...
                            disabled={actionLoading === a.id}
                            title="Delete Asset"
                            className="p-1.5 hover:bg-red-50 dark:hover:bg-red-500/10 text-red-500 rounded-lg transition-colors inline-flex border border-transparent disabled:opacity-50"
                          >
